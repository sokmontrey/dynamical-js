...
import PhysicBodyRenderer from "./PhysicBodyRenderer";

export interface CircularKinematicRendererProps {
    radius_line?: LineStyleProps;
    motion_path?: CircleStyleProps;
    selected?: CircleStyleProps;
}

export default class CircularKinematicRenderer extends PhysicBodyRenderer {
    ...
    }: CircularKinematicRendererProps = {}) {
        super();
